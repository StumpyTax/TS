/* 
  После добавления enum код легче читается, при выборе вариантов движения понятно направления, 
  т.к это больше не безликие цифры 0-3 а буквально направления движения.
*/
